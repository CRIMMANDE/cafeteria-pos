...
if not defined POS_HOST set "POS_HOST=192.168.1.247"
...
if not defined POS_AUTO_OPEN_LARAGON set "POS_AUTO_OPEN_LARAGON=0"

set "POS_URL=http://%POS_HOST%:%POS_PORT%"
set "POS_HEALTH_URL=%POS_URL%/favicon.ico"
