...
class SalesCutExcelExportService
{
    public function createFile(array $columns, array $rows, CarbonInterface $inicio, CarbonInterface $fin): array
    {
        ...
        $path = $tmpDir . DIRECTORY_SEPARATOR . 'sales_cut_' . Str::uuid()->toString() . '.xlsx';
    ...
    private function workbookXml(): string
    {
        return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'
            ...
            . '<sheets><sheet name="Ordenes" sheetId="1" r:id="rId1"/></sheets>'
            . '</workbook>';
    }
